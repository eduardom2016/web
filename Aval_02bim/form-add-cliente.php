...
<html><head>
    ...
    <div id="homeCarousel" class="carousel slide carousel-home" data-ride="carousel">
        ...
        <div id="variavel">
		<form method="post" name="formCadastro" action="add-cliente.php" enctype="multipart/form-data" onSubmit="return validacao()">
			...
			<table width="100%">
				...
				<tr>
					...
					<td width="82%"><input type="text" name="txtEmail" id="email"></td>
				</tr>				
